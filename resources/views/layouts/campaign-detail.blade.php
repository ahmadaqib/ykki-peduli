        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('home') }}" class="text-sm font-medium text-neutral-700 hover:text-neutral-900">
                        Beranda
                    </a>
                </div>
            </div>
    ...
    <footer class="border-t border-neutral-200 bg-white mt-16">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 border-t border-neutral-200 pt-8 text-center text-sm text-neutral-600">
                <p>&copy; {{ date('Y') }} Yayasan Kesehatan Kanker Indonesia. All rights reserved.</p>
            </div>
        </div>
    </footer>

    @vite(['resources/js/app.js', 'resources/js/components/payment-modal.js'])
</body>
</html>
